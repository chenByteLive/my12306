...
public class PageUtils {
    ...
    public Page convert(long current, long size) {
        return new Page(current,size);
    }

    public Page convert(PageRequest pageRequest) {
        return new Page(pageRequest.getCurrent(), pageRequest.getSize());
    }

    public PageResponse convert(IPage page) {
        return buildConventionPage(page);
    }
